...
const methodDescriptor_PingPong_Ping = new grpc.web.MethodDescriptor(
  ...
  proto.deqs.Quote.deserializeBinary
);
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.deqs.Quote)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.deqs.Quote>|undefined}
 *     The XHR Node Readable Stream
 */
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.deqs.Quote>}
 *     Promise that resolves to the response
 */
